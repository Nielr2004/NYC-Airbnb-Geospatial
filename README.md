# 🗽 The Airbnb Insider: NYC Geospatial Analysis
...
* **Hidden Gems:** Found over 150 listings in Manhattan priced under $150 with 100+ reviews.
* **Tech Stack:** Python, Folium (Leaflet.js), Pandas, Seaborn.

## 🚀 How to Run
1. Clone the repo.
2. Install dependencies: `pip install -r requirements.txt`
3. Open `Airbnb_Maps.ipynb`.